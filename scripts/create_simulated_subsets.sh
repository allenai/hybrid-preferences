...
python3 -m scripts.sample_best_subset \ 
    ...
    --model_path data/helpsteer2_$model_model/model.pkl \
...
python3 -m scripts.sample_best_subset \ 
    ...
    --model_path data/alpacafarm_$model_model/model.pkl \
    --budget 0.25 0.50 0.75 \
    --response_a_col response_a --response_b_col response_b \
    --sampling_method $sampling
...
python3 -m scripts.sample_best_subset \ 
    ...
    --model_path data/multipref_$model_model/model.pkl \
    --budget 0.25 0.50 0.75 \
    --response_a_col response_a --response_b_col response_b \
    --sampling_method $sampling
...
python3 -m scripts.sample_best_subset \ 
    ...
    --model_path data/chatarena_$model_model/model.pkl \
    --budget 0.25 0.50 0.75 \
    --response_a_col response_a --response_b_col response_b \
    --sampling_method $sampling
